      ...
      <div class="bottom">
        ...
        <div class="list">
          ...
          <van-list v-model="loading" :finished="finished" @load="onLoad">
            ...
            >
              <li style="padding: 2px">单号：{{ source.FMOBillNo }}</li>
              <li style="padding: 2px">日期：{{ source.FDate }}</li>
              <li style="padding: 2px">产品编码：{{ source.FCPInvCode }}</li>
              <li style="padding: 2px">产品名称：{{ source.FCPInvName }}</li>
              <li style="padding: 2px">数量：{{ source.FCPQty }}</li>
              <li style="padding: 2px">
                备注：
                <p style="word-break: break-all; white-space: normal; word-wrap: break-word">{{ source.FMemo }}</p>
              </li>
            </ul>
          </van-list>
...
import { getStockOutHead } from '@/api/cm'
export default {
  name: `cm`,
  data() {
    return {
